...
const comment = (props) => {
    return (
        <div className="comment">
            <div className="comment__iconbox">
                <div className="comment__icon">
                    <img src={props.iconUrl} alt="icon" />
                </div>
            </div>
            <div className="comment__mainbox">
                <div className="comment__title">
                    {props.authorName}
                    <span className="comment__publish">{ dateDiffText(new Date(props.updateDate), new Date())}</span>
                </div>
                <div className="comment__main">
                    {props.displayText}
                </div>
                <div className="comment__social">
                    <svg className="icon thumbs-up" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 2 22 22">
                    ...
                    <span className="comment__count">{props.likeCount !== 0 ? props.likeCount : '' }</span>
                    <svg className="icon thumbs-down" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="3 2 22 22">
