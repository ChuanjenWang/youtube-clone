...
class SearchBar extends Component {
    ...
    inputChangedHandler = (event) => {
        ...
        this.props.onSearchStart(event.target.value);
    }
        ...
        return (
            <div className="search-bar">
                ...
                <button onClick={(event) => this.searchClickedHandler(event)}>
                    <svg className="search-bar__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 20 20">
