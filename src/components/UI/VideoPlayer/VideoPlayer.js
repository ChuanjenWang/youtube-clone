    ...
    render() {
        if (!this.props.selectedVideo) {
            ...
            <div className="video-player">
                <div className="video-player__loading embed-responsive"></div>
                <div className="video-player__title__loading"></div>
                <div className="video-player__info__loading">
                    <div className="video-player__views__loading"></div>
                    <div className="video-player__social__loading"></div>
                </div>
            </div>);
        }
        ...
        return (
            <div className="video-player">
                ...
                <div className="video-player__info">
                    ...
                    <div className="video-player__social">
                        <ul>
                            <li className="video-player__social_like">
                                <svg className="icon thumbs-up" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 22 22">
                                ...
                                <span className="video-player__socail__words">{likeCount}</span>
                            </li>
                            <li className="video-player__social_dislike">
                                <svg className="icon thumbs-down" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="1 2 22 22">
                                ...
                                <span className="video-player__socail__words">{disLikeCount} </span>
                            </li>
                            <li>
                                <svg className="icon forward" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 20 20">
                                    <title>forward</title>
                                    <path d="M12 11.874v4.357l7-6.69-7-6.572v3.983c-8.775 0-11 9.732-11 9.732 2.484-4.388 6.237-4.81 11-4.81z"></path>
                                </svg>
                                <span className="video-player__socail__words">SHARE</span>
                            </li>
                            <li>
                                <svg className="icon save" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 20 20">
                                    <title>forward</title>
                                ...
                                <span className="video-player__socail__words">SAVE</span>
                            </li>
                            <li>
                                <svg className="icon dots-three-horizontal" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 2 20 20">
